...
<div class="container">
    <div class="row">
        <div class="col-sm-10"><h1>${user.username}</h1>
        </div>
        <div class="col-sm-2"><a href="/logout" class="pull-right">Logout</a>
        </div>
    </div>
    <div class="row">
        <div class="col-sm-3"><!--left col-->
            ...
            <ul class="list-group">
                ...
                <li class="list-group-item text-right"><span
                        class="pull-left"><strong>Joined</strong></span> ${user.joined}
                </li>
                <li class="list-group-item text-right"><span class="pull-left"><strong>Last seen</strong></span>
                    ${user.lastseen}
                </li>
                <li class="list-group-item text-right"><span class="pull-left"><strong>Real name</strong></span> Joseph
                    Doe
                </li>
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body" id="myTasksAsOwner">
                </div>
            </div>
...
<script id="myTaskTemplate" type="text/x-handlebars-template">
    <table id="output">
        <thead>
        <th>id</th>
        <th>title</th>
...
<script type="text/javascript">
    ...
    function test(cat_id) {
        var api_url = "http://localhost:8080/api/category/" + cat_id;
